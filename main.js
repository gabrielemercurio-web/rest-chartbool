$(document).ready(function() {
    ...
    $('#form button').on('click', function () {
        ...
        var salesman_select = $('.venditore option:selected').text();
        console.log(salesman_select);

        var mese_select = $('.mese').val();
        console.log(mese_select);
        if (mese_select == 00) {
            alert('Devi selezionare un mese!');
        }

        var valoreVendita_input = $('#form input').val();
        console.log(valoreVendita_input);
        ...
        $.ajax ({
            ...
            'method': 'POST',
            'data': {
                "salesman": salesman_select,
                "amount": valoreVendita_input,
                "date": "20/" + mese_select + "/2017",
            },
                ...
                $.ajax ({
                    ...
                    'success': function(data) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            ...
                            var fatturato_corrente = parseInt(dati_venditore.amount);
